...
|-------|-------------|--------------------------|-------|------|----------|
|<a id='libgit2' />[libgit2](https://libgit2.github.com/)|[GPL-2.0-only WITH Libgit2-exception](https://github.com/libgit2/libgit2/blob/master/README.md#license 'GPLv2-only with libgit2 linking exception')|portable, pure C implementation of the Git core methods [deps: _openssl, zlib, libssh2_]| |[upstream](https://github.com/libgit2/libgit2 'github.com/libgit2/libgit2')|  [patch]|
...
Dependency version check: all 8 parent-manifest versions match pinned versions.
